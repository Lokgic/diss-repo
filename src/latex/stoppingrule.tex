...
\includegraphics[scale=0.5]{Expectedchange.png}
	\caption{Net gain in expectation after $x$ observations from $p=0.9,0.1,0.5$. Note: it does not dip below 0, which implies that one is never worse off from getting new evidence.}
