...
believe in the future? This is the concern addressed by the principle of
...
\(K\) now at \(t_1\) must be one of the values you consider as possible
in the future at \(t_2\). Van Fraassen formulates this general version of
the principle in order to accommodate imprecise probabilities and vague
opinions. To make the content manageable, I leave issues regarding imprecise probabilities aside:
when talking about probability, in our context it is sufficient to use a
version of Reflection that presupposes precise probability:

\begin{quote}
\emph{Special Reflection Principle.}\footnote{\cite{beliefwill}, 244.} \(P_t(E|p_{t+x} (E) = r)=r\)
\end{quote}

In other words, this formulation says: your subject probability for \(E\)
...
rationality, it must impose at least \emph{some} constraints on our
...
rationality; however, it is still rather mysterious that the conception of one's future self should constrain our current rationality. To understand this, we have
...
Logically, and, more specifically, extensionally, speaking, an utterance or thought like \ref{eq:moorepararain} is not contradictory:
There is no logical connection between my belief in the rain and whether
it is actually raining. This can be demonstrated by rephrasing
...
What does the possibility of Moorean absurdity suggest? We could understand absurdity as an result of a violation of
established norms. That is, there are implicit standards that govern the
...
people do not make deceptive assertions. In such a case the norms are
...
Thus, one explanation for Moore's paradox is that it signifies a violation of
...
a speaker fails to fulfill the normative conditions necessary for the act
...
Like \ref{eq:moorepararain}, this proposition appears
...
For instance, a promise could be unreasonable---it would unreasonable for the promisor to make the promise---if the action required to
fulfill the promise is impossible, since this means the promisor will
...
or false, and a probabilistic assertion or judgment is a qualified expression of an opinion.
...
\end{equation}
is an instance of a Moorean absurdity. More specifically, anyone who
...
There is a parallel to making promise: if I make a promise today, it is implied that I will keep the promise tomorrow, and a promise shouldn't be considered as legitimate if I willingly put myself in a situation that will make me break the promise. For instance, if I made a promise to
...
violating Reflection will lead to the susceptibility to a 
Dutch book---a set of bets that will lead to a guaranteed loss
for anyone who accepts it. A Dutch book \emph{argument} is aimed to
demonstrate that the vulnerability to Dutch books is a sign of incoherence
...
Initially van Fraassen uses a Dutch book argument to argue for the
special Reflection principle.\footnote{\cite{beliefwill}, 244.} However, he has
...
Nevertheless, it is a useful illustration on how the violation of
...
An interpretation of this somewhat difficult passage is this: the projection  that my future self will be epistemically superior involves my assumption as to how I shall conduct my endeavors in accordance with the standard to which I hold myself; therefore, if, according to my conception of my future self, I happen to revise my belief, it should be the result of the application to a rational policy. Another way 
...
conceive of rationally thinking \emph{that} in the future, my rational course of
action \emph{now} is to take heed of my future self and revise my spending
habits.
...
likely see evidence at midnight that will drastically change his
current prediction, he should base his opinion on what his future self at
midnight \emph{would} believe with evidence coming at midnight, instead of his 6 p.m. self.
...
Reflection is anticipated impaired judgments.\footnote{\cite{cleverbookies}, 234--37.} David Christensen  asks us to
consider a person \(B\) who has taken a state of mind altering drug that
causes one to believe strongly that she could fly. Suppose \(B\) is
considering her probability of being able to fly right after taking the drug
...
affirmatively, we need to locate a social convention that penalizes the
...
bet provides an important clue. In specific decision-theoretical analyses of, say, business decisions, we are entitled to expect a stakeholder will act in accordance with her some internal consistency.  To put the matter more positively, this is also saying that 
Reflection \emph{does} work in some specific context, for example, a highly structured environment, say, a game, in which I am contractually
...
a sure loss if I did not. This suggests to me that Reflection is required only in contrived
...
Epistemic judgments are more context-dependent than making promises. This, I think, is unaccounted for by voluntarism. Probabilistic judgment that serves the aim of knowledge is the exception to how we usually behave and not a norm. Therefore, my proposal is that, instead of trying to demonstrate how Reflection would work in multifarious contexts, we should focus on how Reflection would bear on assertions made \emph{in the different contexts of inquiry}: making conjectures about a phenomenon of interest, verifying a prediction, etc. We need a richer conception of our epistemic practice, which, I suggest, can be found in Peirce's pragmatism, to which we shall now turn.
...
The operationalist reading of the Pragmatic Maxim may sound suspiciously like the logical positivists' verificationism, which says, roughly, the meanings of words are entirely reducible to
...
behave in formal logic. Consider that the following is a property of the
...
relevant to this statement. If the other person asks whether the match was underwater, I would be entitled to be somewhat incredulous, since I would assume that's the context. Thus, we are entitled to claim to have a understanding of the match's lighting behavior, only when we have our ability to pinpoint the exact context in which the counterfactual conditional is true.
...
property of being hard into nothing but a list of facts pertaining to the
diamond being scratched, but an epistemological point about how
properties such as hardness can be probed through learning how it
\emph{would} behave under all conceivable scenarios, including
counterfactual ones.\footnote{\cite{CP}, 5.453.} Only then are we entitled to say that we have
...
belief. But the effect here is not a causal one, but a rational
one.
...
context in which the speaker's failure to fulfill this responsibility will
lead to ``very real effects'', such as the risk of legal jeopardy. Peirce recognizes that the subtle differences of context make a world of
...
pertaining to what one had eaten in the past are rarely relevant in
situations where the speaker's intention will be called into question, but it is not difficult to imagine how it could be changed. For instance, a person on a strict diet should report to her nutritionist truthfully. The loss of memory is pre-mitigated  by the use of aids such as just writing it down. In such a case, memory loss is not so excusable. The difference is more obvious if a speaker is testifying in a court of law under oath,
she is expected to stand by any assertion that is made in future.
Inconsistency due to faulty memory is strictly regulated
through the hearsay rule and cross-examination, and violations have explicit consequences on the epistemic standing of the speaker as a credible witness. \footnote{\cite{forgetful}, 167.}
...
considered rational so long as the agent acts in accordance with it in
...
Peirce is responsible for the distinction between abduction, deduction and
...
and induction broadly not only as distinct types of \emph{inferences},
 but also different \emph{tasks} involved in our practice of
...
of inference to the best explanation. This is essential, because
(1) contemporary philosophers of science often use abduction as a
synonym of inference to the best explanation, and (2) van Fraassen is well-known for arguing against
any attempt to incorporate inference to the best explanation in the context of probabilistic
...
that accepts inference to the best explanation as an indispensable
rule of \emph{inductive} inference. In its most naive form, inference to the best explanation says
...
well-known for arguing against inference to the best explanation in this naive form. In
its most powerful form---a view that van Fraassen does ascribe
to some philosophers---inference to the best explanation can be construed as a solution to Hume's
...
inference to the best explanation gets us out of this problem by giving justificatory force to
...
Van Fraassen suggests that, in light of the criticisms against naive inference to the best explanation, the strongest recourse available the
supporters of inference to the best explanation is \emph{entrenchment}, which amounts to the
repackaging of inference to the best explanation into a rule that works well with Bayesianism. The more
...
rule of inference to the best explanation would be a recipe for adjusting our personal probabilities
...
explanation', which entitles us to raise the probability of the
best explanation. For instance, consider Peter Lipton's description of his position in \emph{Inference to the Best Explanation}:

\begin{quote}
{[}My{]} version {[}of inference to the best explanation{]} claims that the explanation that would, if
...
Van Fraassen, however, argues that this cannot do. To begin, if inference to the explanation is
to be harmonized with Bayesianism, it must not clash with the Bayesian
procedure of belief revision, i.e., conditionalization, but van Fraassen
argues that probabilistic inference to the best explanation is inconsistent with the Bayesian standard
of rationality. The problem again is Bayesianism's allergy to ampliative
reasoning: probabilistic inference to the best explanation is ampliative, since explanatory virtues go beyond
...
probability. Since probabilistic inference to the best explanation is the rule that confers
...
explanationist's belief after \emph{both} conditionalization and probabilistic inference to the best explanation. A
...
Probabilistic Inference to the Best Explanation}\label{van-fraassens-dutch-book-argument-against-pibe}}
...
Suppose we have tossed the coin 4 times, and they all landed on heads. So
...
biased toward heads. Where
does probabilistic inference to the best explanation come in, then? Van Fraassen asserts that an argument from
probabilistic inference to the best explanation would be as follows: out of the three hypotheses, \(A\) best
\emph{explains} why we see nothing but heads: it's because it's highly
biased. So probabilistic inference to the best explanation should recommend the redistribution of the
...
probabilistic inference to the best explanation.
...
that ensures whoever takes them a loss. Imagine that we are back
...
used probabilistic inference to the best explanation to give a bonus to the most explanatory hypothesis, \(A\),
...
cite van Fraassen's anti-explanatioinst argument, it may sound as though van
Fraassen takes Bayesianism as the correct position by fiat, and, as this line of thought goes, any position that contradicts it is \emph{de facto} an inviable one. Indeed,
...
conditionalization or inference to the best explanation, but that (1) they are not rationally
compelling in and of themselves, and (2) repacking inference to the best explanation as some
probabilistic rule is inconsistent with Bayesian conditionalization.

Many explanationists, including Lipton who misread van Fraassen's argument, attempts to challenge van Fraassen's negative argument heads
on, by defending that both conditionalization and probabilistic inference to the best explanation are rationally
compelling. By taking this approach, explanationists have to argue for
the legitimacy of probabilistic inference to the best explanation within the stringent requirement of Bayesianism.
...
strategy here is a mixture of neutralizing probabilistic inference to the best explanation so that it will not get
in the way of conditionalization, and providing incentives for Bayesians
to adopt it by amplifying or emphasizing probabilistic inference to the best explanation in areas where
...
strengthening probabilistic inference to the best explanation without either trivializing it or over-promising what
inference to the best explanation can do. Some examples: Samir Okasha argues for a view that appeals to the phenomenology of explanation.\footnote{\cite{okasha}} By appealing to behavioral economics, Lipton argues for a view that interprets probabilistic inference to the best explanation as a heuristic for how people, as a matter of psychology, do Bayesian computation in everyday reasoning.\footnote{\cite{lipton}, chapter 7} Jonathan Weisberg proposes to do away conditionalization altogether, but he proposes to couple probabilistic inference to the best explanation with a even stricter conception of rational degrees of belief like Keynes has (\ref{sec:rational-degrees-of-belief}), requiring the recommendations of probabilistic inference to the best explanation to somehow coincide perfectly with the probability assignments of \emph{the} one true probability function.\footnote{\cite{locatingibe}}

These attempts try to repackage probabilistic inference to the best explanation into something that is less like a normative rule and more like an empirical story. This is necessitated by accepting that conditionalization is the sole possible move in response to evidence. I think that these philosophers have played right into van Fraassen's hands by engaging in armchair psychology while trying to appease the Orthodox Bayesian. Alternatively, we could take a path of less resistance: instead of
...
statistical reasoning, but I also agree with van Fraassen that probabilistic inference to the best explanation is a non-senscial rule. 
...
The important idea is that explanatory reasoning does not belong to the domain of explicative reasoning. Accepting this, however, means that we should not look for reliable inferences in explanations. The permissiveness of the voluntaristic conception of rationality is
characteristic of ampliative reasoning that occurs within the context of
...
instance, a hypothesis that in any way explains the phenomenon under
investigation is permissible. Sometimes Peirce uses the
...
While Peirce does not seem to think that this schema encompasses all possible forms of abductions, it is nevertheless a helpful starting point: \(C\) is the observed \emph{fact} that calls for a
...
Peirce's view on abductive rationality, then, \emph{is} voluntarism: in the context of abduction, we are free to extrapolate ampliatively.  
...
According to this Peircean view, the validity of inductive reasoning is strictly
regulated by the statistical structure deducible from the commitments
...
can be seen as a requirement to hold an experimental version of Reflection:
...
described; otherwise, the inference is illegitimate. The thought is that the presupposition that the experimenter has faithfully fulfilled her duty is a background assumption in the context of induction, because statistical sampling can easily be gamed:
...
the investigator can keep on sampling until she finds a sample that
...
This serves as an important transition to the next chapter. Peirce's Pragmatic Maxim and tripartite classification of different contexts of inquiry provide a unified way of understanding how epistemic commitments figure into our probabilistic inferences and experimental procedures. Making inductive inferences based on experimental procedures presupposes that we can rely on the experiment to behave deliberately in accordance with the setup of the experiment promised at the outset. If the experiment is stopped earlier or later than promised, the character of the inference could be drastically change. How inferences could be dependent on whether or not these practical commitments are satisfied is the focus of the next chapter. 
