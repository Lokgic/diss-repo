...
Still, we need to find a balance between understanding weight as volume and weight as : Savage ponders this problem: a sick person is contemplating whether or not to find out if her sickness is terminal.[@savage, p.107] Assuming thThis person might decide against getting the evidence on the ground that if the sickness turned out to be . Savage's response is that in this case the information just *seems* free, and the cos is potential psychological that the 
 -->
